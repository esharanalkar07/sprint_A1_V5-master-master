    ...
    <div class="input-field">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="firstname" style="width:20em;" placeholder="Enter your Firstname" value="<?php echo @$firstname; ?>" required pattern="[a-zA-Z .]+" />
            </div>
            <div class="form-group">
                <label>Subject</label>
...
<footer><center><br>Brought To You By: Technical Babaji</center></footer>
</html>